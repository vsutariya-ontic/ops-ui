      ...
      >
        ...
        >
          <div className="w-full flex justify-between h-full">
            ...
            <Typography component="h1" variant="h5" className="w-fit">
              {role} {type}
            </Typography>
            <div></div>
          </div>
          ...
          >
            ...
            <Button
              ...
              className="mt-3 mb-2"
              fullWidth
              disabled={loginMutation.isLoading || addUserMutation.isLoading}
            >
              {type}
            </Button>
            {type === "Login" && (
              <Grid container className="flex w-full justify-between">
                <Grid item xs>
                  {/* <Link
                                        href="#"
                                        variant="body2"
                ...
                <Grid
                  item
                  style={{
                    display: role === "PantryBoy" ? "none" : "inherit",
                  }}
                >
                  <button
                    onClick={() => {
